...
theme.bg_systray = "#282a36" -- doesn't stand out in the gradient background
...
theme.taglist_bg_empty = "#44475a00"
...
theme.tasklist_bg_minimized = theme.wibar_bg
...
theme.wallpaper = "/home/misha/.config/awesome/themes/dracula/wallpaper.jpg"
